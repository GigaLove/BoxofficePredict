 ...
 * @author GigaLiu
 */
public class StarImpactPojo extends StarPojo {
    ...
    public StarImpactPojo() {
        
    }
    
    public StarImpactPojo(long id, String name, int type, String worksJson) {
        super(id, name, type);
        try {
            ...
            Logger.getLogger(StarImpactPojo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    
    public StarImpactPojo(String name, int starRank, double impactIndex, int type,
