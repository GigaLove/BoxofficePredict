...
public class BoxofficeConst {
    ...
    static {
        ...
        YEAR_HIGHEST_BOXOFFICE.put(2007, 28200);
        YEAR_HIGHEST_BOXOFFICE.put(2006, 29100);
        YEAR_HIGHEST_BOXOFFICE.put(2005, 18100);
        YEAR_HIGHEST_BOXOFFICE.put(2004, 17300);
        YEAR_HIGHEST_BOXOFFICE.put(2003, 5300);
        YEAR_HIGHEST_BOXOFFICE.put(2002, 25000);
        YEAR_HIGHEST_BOXOFFICE.put(2001, 10400);
        YEAR_HIGHEST_BOXOFFICE.put(2000, 12000);
    }
