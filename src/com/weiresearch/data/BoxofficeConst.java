...
public class BoxofficeConst {
     ...
     * 2011-2015票房占比
     */
    public static final float[] YEAR_BOXOFFICE_RATIO;

    static {
        YEAR_BOXOFFICE_RATIO = new float[YEAR_BOXOFFICE.length];
        int sum = 0;
     ...
     * 2011-2015历年平均票房比例
     */
    public static final float[] YEAR_AVG_BOXOFFICE_RATIO;
    ...
    static {
        ...
        YEAR_AVG_BOXOFFICE_RATIO = new float[YEAR_AVG_BOXOFFICE.length];
        for (int i = 0; i < YEAR_AVG_BOXOFFICE.length; i++) {
